...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #---------------------------------------------------------------------------------------------------------------------#
      [    :photo_items_tab        ,    'Photo Items'        ,    photo_items_path        ,    true        ,    true        ],
      [    :photo_galleries_tab    ,    'Photo Galleries'    ,    photo_galleries_path    ,    true        ,    true        ],
  ...
  config.actions do
    [
      ...
      #--------------------------------------------------------------------------#
      [    :photo_items        ,    :all_actions    ,    :photo_items_tab        ],
      [    :photo_galleries    ,    :all_actions    ,    :photo_galleries_tab    ],
